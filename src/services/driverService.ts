...
export const driverService = {
  ...
  async createDriver(formData: any, avatarUrl: string) {
    if (!isAdminKeyAvailable) throw new Error("Service Role Key is missing. Cannot create driver directly.");
  ...
  async updateDriver(userId: string, data: any) {
    if (!isAdminKeyAvailable) throw new Error("Service Role Key is missing. Cannot update driver directly.");
